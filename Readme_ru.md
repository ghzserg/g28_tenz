...
Внимание! Рекомендуется установить Z-Offset = 0.0. А далее уже настраивать его.
...
# Если появиласть ошибка zstop.cfg

Нужно зайти в `mod_data/plugins/g28_tenz` и создать файл вот с таким содержанимем
